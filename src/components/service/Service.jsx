        ...
        <div className="service">
          ...
          <div className="explanation">
            ...
            <p>
              ...
              &nbsp;
              <Link to="/support">Customer support.</Link> We take a
              responsivility about quarity of merchandise.
            </p>
          </div>
        </div>
        <div className="service">
          ...
          <div className="explanation">
            <p>
              Your order cancellation is FREE within 24 hours from your order.
              The cancellation fee is based on our cancellation policy written
              below.
            </p>
            <h3>
              Free (order - 24Hours)
            ...
            <p>
              Please contact to <Link to="/support">Customer support</Link> for
